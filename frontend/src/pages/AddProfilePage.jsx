...
const ROLES = [
  "SDE-1", "SDE-2", "SDE-3", "Senior Software Engineer",
  ...
  "Data Analyst", "Research Engineer", "Consultant", "Other",
];

const CITIES = [
  "Bangalore", "Hyderabad", "Pune", "Mumbai", "Delhi", "Chennai",
  "Kolkata", "Agartala", "Noida", "Gurugram", "Ahmedabad",
  "Austin", "Seattle", "San Francisco", "New York", "London",
  "Singapore", "Toronto", "Dubai", "Other",
];
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
      <label style={{
        ...
        {label}
        {required && <span style={{ color: "#FF4D4D", fontSize: "14px", lineHeight: 1 }}>*</span>}
      </label>
      {hint && <p style={{ fontSize: "11px", color: "#aaa", fontFamily: "'Courier New', monospace", margin: 0 }}>{hint}</p>}
      {children}
      {error && <p style={{ fontSize: "11px", color: "#FF4D4D", fontFamily: "'Courier New', monospace", margin: 0 }}>↑ {error}</p>}
    </div>
  );
}
...
function Input({ type = "text", placeholder, value, onChange, error, ...rest }) {
    ...
    <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
      ...
      <div style={{
        ...
        {image
          ...
          : <span style={{ fontSize: "22px", fontWeight: 800, color: "#fff", fontFamily: "'Courier New', monospace" }}>{initials}</span>
        }
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        <label style={{
          ...
          onMouseLeave={(e) => { e.currentTarget.style.background = "#fff"; e.currentTarget.style.color = "#555"; e.currentTarget.style.borderColor = "#e8e8e4"; }}
        >
          Upload Photo
          <input
        ...
        <p style={{ fontSize: "11px", color: "#bbb", fontFamily: "'Courier New', monospace", margin: 0 }}>
...
export default function AddProfilePage() {
  ...
  const [form, setForm] = useState({
    ...
    city: "", email: "", password: "", confirmPassword: "",
    linkedin: "", image: null,
  });
  ...
  const validate = () => {
    ...
    if (form.linkedin && !/^https?:\/\/.+/.test(form.linkedin)) e.linkedin = "Must start with https://";
    return e;
  };
  ...
  if (submitted) {
    return (
      <Layout>
        <div style={{
          paddingTop: "60px", minHeight: "100vh", background: "#fafaf8",
          display: "flex", alignItems: "center", justifyContent: "center",
          flexDirection: "column", gap: "1.5rem", textAlign: "center", padding: "5rem 2rem",
        }}>
          ...
          <h2 style={{ fontSize: "36px", fontWeight: 900, color: "#111", fontFamily: "'Georgia', serif", letterSpacing: "-1px", margin: 0 }}>Profile Submitted!</h2>
          <p style={{ fontSize: "14px", color: "#888", fontFamily: "'Courier New', monospace", maxWidth: "380px", lineHeight: 1.7 }}>
            Welcome to NITALUM, <strong>{form.name.split(" ")[0]}</strong>! Your profile is under review and will be live shortly.
          </p>
          <div style={{ display: "flex", gap: "12px", marginTop: "0.5rem" }}>
            ...
            >Go to Home →</button>
            <button onClick={() => { setSubmitted(false); setForm({ name: "", batch: "", company: "", role: "", city: "", email: "", password: "", confirmPassword: "", linkedin: "", image: null }); }} style={{
              background: "transparent", color: "#888", border: "1px solid #e8e8e4",
              padding: "12px 28px", borderRadius: "50px", fontSize: "13px",
              fontFamily: "'Courier New', monospace", cursor: "pointer",
      ...
      <div style={{ paddingTop: "60px", minHeight: "100vh", background: "#fafaf8" }}>
        ...
        <div style={{ borderBottom: "1px solid #e8e8e4", padding: "3rem 2.5rem 2rem", background: "#fafaf8" }}>
          <div style={{ maxWidth: "640px", margin: "0 auto" }}>
            <p style={{ fontSize: "11px", color: "#FF4D4D", letterSpacing: "3px", textTransform: "uppercase", fontFamily: "'Courier New', monospace", marginBottom: "0.4rem" }}>— Join the Network</p>
            <h1 style={{ fontSize: "clamp(32px, 6vw, 56px)", fontWeight: 900, color: "#111", fontFamily: "'Georgia', serif", margin: 0, letterSpacing: "-1.5px", lineHeight: 1.05 }}>
              Add Your<br />Profile.
            </h1>
            <p style={{ fontSize: "13px", color: "#888", fontFamily: "'Courier New', monospace", marginTop: "0.75rem", lineHeight: 1.7 }}>
              Fill in your details and join hundreds of NITA alumni already on the platform.
            </p>
          </div>
        </div>

        {/* Form */}
        <div style={{ maxWidth: "640px", margin: "0 auto", padding: "3rem 2.5rem 5rem" }}>

          {/* ── Avatar ── */}
          <div style={{ marginBottom: "2.5rem", paddingBottom: "2.5rem", borderBottom: "1px solid #f0efeb" }}>
            <Field label="Profile Photo" hint="Optional — we'll use your initials if you skip this">
              <AvatarUpload
                name={form.name}
                image={form.image}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", marginBottom: "2.5rem" }}>
            <Field label="Full Name" required error={errors.name}>
              <Input placeholder="e.g. Arjun Sharma" value={form.name} onChange={set("name")} error={errors.name} />
            </Field>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", marginBottom: "2.5rem" }}>
            <Field label="Current Company" required error={errors.company}>
              <Input placeholder="e.g. Amazon, Google, TCS" value={form.company} onChange={set("company")} error={errors.company} />
            </Field>
            ...
            <Field label="LinkedIn URL" hint="We'll show this on your profile card">
              <Input
          ...
          <p style={{ fontSize: "12px", color: "#aaa", fontFamily: "'Courier New', monospace", marginBottom: "1.5rem", lineHeight: 1.6 }}>
            Your email is your login ID. Set a password so you can edit your profile later.
          </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem", marginBottom: "3rem" }}>
            ...
            <Field label="Confirm Password" required error={errors.confirmPassword}>
              <div style={{ position: "relative" }}>
                ...
                />
                <button onClick={() => setShowCpw(!showCpw)} style={{
                  position: "absolute", right: "12px", top: "50%", transform: "translateY(-50%)",
                  background: "none", border: "none", cursor: "pointer", padding: "2px",
                }}>
          ...
          {Object.keys(errors).length > 0 && (
            <p style={{ fontSize: "12px", color: "#FF4D4D", fontFamily: "'Courier New', monospace", marginTop: "1rem" }}>
